// FROM: https://github.com/alex-okrushko/backoff-rxjs/blob/5702674645b041aa9260d0e7957406c36a0aced5/src/operators/retryBackoff.ts
          ...
          errors.pipe(
            concatMap((error) => {
              ...
              return iif(
                ...
                // FIXME: RxA CDK timer doesn't emit properly
                timer(
